...
byte defcard[][4]={{0x15,0x28,0x81,0xCE},{0x75,0x7C,0x55,0xCE},{0x75,0x5D,0x5A,0xCE},{0x55,0xBD,0x7B,0xCE}};
void setup()
{    Serial.begin(9600); 
    Wire.begin(9) ;
    ...
    tft.setTextSize(2);
    tft.setCursor(20,80);
    tft.print("USE YOUR SMART CARD TO SCAN AND MAKE") ;
    tft.setCursor(20,102);
    tft.print("PAYMENT FOR PARKING , THEN SEE EMPTY") ;
    ...
    tft.print("WAVE THE CARD AGAIN, FOR RECORDS") ;
...
i=i+1;
    ...
    if( stateM[0] == '1' && stateM[1] =='0' )
  {
    ...
    tft.fillRect(20,210,65,60,MAGENTA);
    
    tft.fillRect(25,215,55,50,GREEN);
    tft.setTextColor(BLACK) ;
    tft.setCursor(42,225);
    tft.setTextSize(4);
    tft.print("1") ;
    
    tft.fillRect(  95,210,65,60,MAGENTA);
    
    tft.fillRect( 100,215,55,50,RED);
    tft.setTextColor(WHITE) ;
    tft.setCursor(118,225);
    tft.setTextSize(4);
    tft.print("2") ;
    
    tft.fillRect(170,210,65,60,MAGENTA);
    
    tft.fillRect(175,215,55,50,RED);
    tft.setTextColor(WHITE) ;
    tft.setCursor(194,225);
    tft.setTextSize(4);
    tft.print("3") ;
    
    tft.fillRect(245,210,65,60,MAGENTA);
    
    tft.fillRect(250,215,55,50,RED);
    tft.setTextColor(WHITE) ;
    tft.setCursor(270,225);
    tft.setTextSize(4);
    tft.print("4") ;
    
    tft.fillRect(320,210,65,60,MAGENTA);
    
    tft.fillRect(325,215,55,50,RED);
    tft.setTextColor(WHITE) ;
    tft.setCursor(343,225);
    tft.setTextSize(4);
    tft.print("5") ;
    
    tft.fillRect(395,210,65,60,MAGENTA);
    
    tft.fillRect(400,215,55,50,RED);
    tft.setTextColor(WHITE) ;
    tft.setCursor(417,225);
    tft.setTextSize(4);
    tft.print("6") ;
  ...
  else if( stateM[0] == '2' && stateM[1] == '0')
  {
   tft.fillRect(20,33,444,275,PURPLE);
    ...
    tft.print("2") ;}
      ...
      tft.fillRect( 100,215,55,50,GREEN);
    tft.setTextColor(BLACK) ;
    tft.setCursor(118,225);
    tft.setTextSize(4);
    tft.print("2") ;
    ...
    tft.print("3") ;}
      ...
      tft.fillRect(175,215,55,50,GREEN);
    tft.setTextColor(BLACK) ;
    tft.setCursor(194,225);
    tft.setTextSize(4);
    tft.print("3") ;
    ...
    tft.print("4") ;}
      ...
      tft.fillRect(250,215,55,50,GREEN);
    tft.setTextColor(BLACK) ;
    tft.setCursor(270,225);
    tft.setTextSize(4);
    tft.print("4") ;
